...
```{r}
# loop to find relevant country each year
...
- Use the cut() command to categorize data into intervals and the table() function to create the frequency distribution table.
