...
intro_message <- paste("The company", manufacturer, "has total cost:", total_cost)
...
# Logical vector
bool_values <- c(TRUE, T, TRUE, TRUE)
...
new_fruit <- "pear"
updated_fruits <- c(new_fruit, fruits)
updated_fruits
...
products <- c("Widget A", "Widget B", "Widget F", "Widget D", "Widget E")
...
paste("The total revenue for the last", num_days, "days, is", total_revenue)
...
new_product <- "Widget C"
last_day_sales <- 36.7

daily_sales <- c(daily_sales, last_day_sales)

updated_products <- c(products, new_product)
updated_products[6] <- updated_products[3]
updated_products[3] <- new_product
